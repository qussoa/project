...
public class PropsRestController {
	...
	/*
	 * properties는 프로젝트의 여러 클래스들이 공통적으로 사용하고자 특별히 저장해 놓은 변수를
	 * 
	 * properties로 등록한 프로젝트 변수를 프로젝트에서 참조하여 사용하는 방법
	 * 
	 * @Value(문자열) String 변수명 ==> project에 등록된 properties를 참조하여 해당 문자열을 검색하고 문자열이
	 * 검색되면 문자열 = 값 형식으로 저장된 곳에서 값을 가져와서 변수명에 저장하여 일반 문자열 변수처럼 사용할 있도록 도와준다
	 */

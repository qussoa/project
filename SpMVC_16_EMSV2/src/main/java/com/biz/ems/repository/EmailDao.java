...
//
//	List<EmailVO> findAllByFromEmailAndFromName(@Param("from_email") String from_email,
//											 @Param("from_name") String from_name);
//	
//	List<EmailVO> findAllByFromEmailOrFromName(@Param("from_email") String from_email,
//			 @Param("from_name") String from_name);
}

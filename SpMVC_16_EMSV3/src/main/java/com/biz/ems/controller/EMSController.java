...
public class EMSController {
	...
	public String view(@ModelAttribute("eamilVO") EmailVO emailVO, @PathVariable("ems_seq") String ems_seq,
			Model model) {
	...
	public String delete(@ModelAttribute("emailVO") EmailVO emailVO, @PathVariable("ems_seq") long ems_seq) {

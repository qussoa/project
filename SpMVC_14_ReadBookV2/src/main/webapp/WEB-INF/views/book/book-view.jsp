...
<body>
	<section>
		<article>
			...
			<div class="book-body">
				<fmt:formatNumber value="${BOOK.b_iprice}" type="number"
					maxFractionDigits="3" var="commaPrice" />${commaPrice}

				<fmt:formatNumber value="${BOOK.b_iprice}" type="currency"
					maxFractionDigits="3" var="currPrice" />${currPrice}

...
<link href="${rootPath}/css/rbook-main.css?ver=2020-01-14-001"
	rel="stylesheet">
	...
	<section id="main-writer">
		<article>
			<form:form modelAttribute="rBookVO">
				...
				<br />
				<form:input type="text" path="rb_date" placeholder="독서일자" />
				<br />
				<form:input type="text" path="rb_stime" placeholder="독서시작시간" />
				<br />
				<form:input type="text" path="rb_rtime" placeholder="독서시간" />
				<br />
				<form:input type="text" path="rb_subject" placeholder="한줄평" />
				<br />
				<form:input type="text" path="rb_star" placeholder="별점" />
				<br />
				<form:textarea path="rb_text" />
				<div id="main-button">
					<button id="btn-writer" class="biz-blue flex-right">독서록 작성</button>
				</div>
			</form:form>
		</article>
</body>
